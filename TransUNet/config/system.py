...
if os.path.abspath(".").split("/")[1] == "data1":
    ...
    project_root = '/mnt3/sainingz/TransUNet'# /scratch_net/bmicdl03/code/python/acdc_public_segmenter
    data_root = '/mnt3/sainingz/TransUNet/training'
    test_data_root = '/mnt3/sainingz/TransUNet/testing'
    local_hostnames = ['server-pc']  # used to check if on cluster or not,
else:
